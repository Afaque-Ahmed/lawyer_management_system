                        ...
                        <div class="card-body pt-3">
                            ...
                            foreach ($result as $row) {  }?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['first_name'] . " " .  $row['last_name'] ?></div>
                                    </div>

                                    <div class="row">
                                        <div style="color:#D7B679 ; font-weight: bolder;" class="col-lg-3 col-md-4 label">Contact No#</div>
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['contact'] ?></div>
                                    </div>

                                    <div class="row">
                                        <div style="color:#D7B679 ; font-weight: bolder;" class="col-lg-3 col-md-4 label">CNIC</div>
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['cnic'] ?></div>
                                    </div>

                                    <div class="row">
                                        <div style="color:#D7B679 ; font-weight: bolder;" class="col-lg-3 col-md-4 label">Address</div>
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['address'] ?></div>
                                    </div>

                                    <div class="row">
                                        <div style="color:#D7B679 ; font-weight: bolder;" class="col-lg-3 col-md-4 label">Country</div>
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['country'] ?></div>
                                    </div>

                                    <div class="row">
                                        <div style="color:#D7B679 ; font-weight: bolder;" class="col-lg-3 col-md-4 label">Gender</div>
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['gender'] ?></div>
                                    </div>

                                    <div class="row">
                                        <div style="color:#D7B679 ; font-weight: bolder;" class="col-lg-3 col-md-4 label">D.O.B</div>
                                        <div style=" font-weight: bolder;" class="col-lg-9 col-md-8"><?php echo $row['dob'] ?></div>
                                    </div>
