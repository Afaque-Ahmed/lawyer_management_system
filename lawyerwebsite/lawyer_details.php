            ...
            <div class="container">
                    ...
                    <div class="col-lg-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade text-lg-start text-center" id="v-pills-order" role="tabpanel" aria-labelledby="v-pills-order-tab">
                                ...
                                <ul class="lawyer-edu-list">
                                    <li>
                                        <h4>Case Won</h4><?php echo $row['lawyer_case_done'] ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <?php if ($_SESSION['role'] == "Lawyer") { ?>
                        <div class="col-md-12 ">
                            <button href="appoinment.php?id=<?php echo $row['User_Id'] ?>"><input type="hidden" class="btn" style="width: 100%; border:none; font-size:120%; background-color:#CA9457; "></button>
                        </div>
