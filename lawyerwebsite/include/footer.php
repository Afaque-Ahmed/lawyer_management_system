            ...
            <div class="row gy-5">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-about">
                        <img src="user/assets/images/icons/header1-logo.svg" alt="image">
                        <p>Too much pure hate is not fit to be silenced as an ill-informed partner.</p>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="contact-list">
                            <li>
                                ...
                                <div class="text">
                                    <a href="tel:+92311205844">+923 111 205844</a>
                                    <a href="tel:+93060030263" class="mb-0">+92 306 0030263</a>
                                    <a href="tel:+923330240594" class="mb-0">+92 333 0240594</a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#9cf5f2faf3dcf9e4fdf1ecf0f9b2fff3f1"><span class="__cf_email__" data-cfemail="a9c0c7cfc6e9ccd1c8c4d9c5cc87cac6c4">[email&#160;protected]</span></a>
                                    <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#572422272738252317322f363a273b327934383a" class="mb-0"><span class="__cf_email__" data-cfemail="abd8dedbdbc4d9dfebced3cac6dbc7ce85c8c4c6">[email&#160;protected]</span></a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    Aptech Metro Star Gate Main Shara-e-Faisal Karachi , PAKISTAN
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="row d-flex align-items-center g-3">
                <div class="col-lg-6 d-flex justify-content-lg-start justify-content-center text-lg-start text-center px-1">
                    <p>Copyright 2023 <a href="index.php" class="egns-lab">Core Law </a> | Design By <a href="##" class="egns-lab">A.I.E.G Develops</a></p>
                </div>
