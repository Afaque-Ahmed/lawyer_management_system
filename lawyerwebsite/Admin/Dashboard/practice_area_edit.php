      ...
      foreach ($result as $row) { ?>
        ...
        <div class="col-md-12">
          ...
          <select id="inputState" name="case"  class="form-select">
           ...
           <?php } elseif ($row['name'] == "Health Care Law") {?>
            <option selected value="Health Care Law">Health Care Law</option>
            <option value="Criminal Law">Criminal Law</option>
            <option value="Finance Law">Finance Law</option>
            <option value="Property Law">Property Law</option>
            <option value="Environmental Law">Environmental Law</option>
            ...
            <?php } elseif ($row['name'] == "Environmental Law") {?>
            <option selected value="Environmental Law">Environmental Law</option>
            <option value="Criminal Law">Criminal Law</option>
            <option value="Finance Law">Finance Law</option>
            <option value="Property Law">Property Law</option>
            <option value="Health Care Law">Health Care Law</option>
            ...
            <?php }  elseif ($row['name'] == "Civil Law") {?>
            <option selected value="Civil Law">Civil Law</option>
            <option value="Criminal Law">Criminal Law</option>
            <option value="Finance Law">Finance Law</option>
            <option value="Property Law">Property Law</option>
            <option value="Health Care Law">Health Care Law</option>
        ...
        <div class="col-md-12">
          ...
          <?php 
          if ($row['icon'] == "<i class='fas fa-briefcase'></i>") {?>
     <option selected value="<i class='fas fa-briefcase'></i>">Briefcase</option>
            <option value="<i class='fas fa-landmark'></i>">Landmark</option>
            <option value="<i class='fas fa-money-bill-wave'></i>">Money</option>
            <option value="<i class='fas fa-medkit'></i>"> Medikit</option>
            <option value="<i class='fas fa-leaf'></i>"> Leaf</option>
            <option value="<i class='fas fa-balance-scale-right'></i>">Scale</option>
          <?php } 
          elseif ($row['icon'] == "<i class='fas fa-landmark'></i>") {?>
         ...
         <?php } elseif ($row['icon'] == "<i class='fas fa-medkit'></i>") {?>
            <option selected value="<i class='fas fa-medkit'></i>">Medikit</option>
            <option value="<i class='fas fa-landmark'></i>">Landmark</option>
            <option value="<i class='fas fa-money-bill-wave'></i>">Money</option>
            <option value="<i class='fas fa-briefcase'></i>">Briefcase</option>
            <option value="<i class='fas fa-leaf'></i>"> Leaf</option>
            ...
            <?php } elseif ($row['icon'] == "<i class='fas fa-leaf'></i>") {?>
            <option selected value="<i class='fas fa-leaf'></i>">Leaf</option>
            <option value="<i class='fas fa-landmark'></i>">Landmark</option>
            <option value="<i class='fas fa-money-bill-wave'></i>">Money</option>
            <option value="<i class='fas fa-medkit'></i>"> Medikit</option>
            <option value="<i class='fas fa-briefcase'></i>">Briefcase</option>
            ...
            <?php } elseif ($row['icon'] == "<i class='fas fa-balance-scale-right'></i>") {?>
            <option selected value="<i class='fas fa-balance-scale-right'></i>">Scale</option>
            <option value="<i class='fas fa-landmark'></i>">Landmark</option>
            <option value="<i class='fas fa-money-bill-wave'></i>">Money</option>
            <option value="<i class='fas fa-medkit'></i>"> Medikit</option>
            <option value="<i class='fas fa-briefcase'></i>">Briefcase</option>
