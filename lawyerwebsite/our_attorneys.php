...
$search_input = $_POST['input_value'];
$search_radio = $_POST['radio_btn'];
        ...
        <div class="row mx-0 ">
            <form method="POST" ">
                <div class="col-md-4 mx-auto">
                    ...
                    <input type="text" class="form-control" placeholder="Search Lawyers Here..." value="<?php echo $search; ?>" name="input_value" id="search_input">
                    <span id="search_inputErr" class="error"></span>
                </div>
                <div class="col-md-4 col-sm-6 mx-auto text-center " style="padding-top:15px;">
                    <input type="radio" name="radio_btn" id="search_location" value="location"><span style="margin-right:8px;font-weight:bold;" >Location</span>
                    <input type="radio" name="radio_btn" id="search_services" value="service"><span style="font-weight:bold;" >Services</span>
                </div>
    ...
    <div class="container">
        <div class="row   mb-60">
            ...
            if ($search_radio == "location" && !$search_input == "") {
                $show = "SELECT * FROM `lawyer_details` WHERE   city like '%$search_input%' limit 4 ";
            }elseif($search_radio == "service" && !$search_input == "")
            {
                $show = "SELECT * FROM `lawyer_details` WHERE  lawyer_type like '%$search_input%' limit 4 ";
            ...
            if ($pdo_statement->rowCount() > 0) {
                foreach ($result as $row) {  ?>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-10  mt-3 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="attorney-single sibling2">
                            ...
                            <div class="content">
                                ...
                                <p class="mt-2 mb-2" style="color: white;  font-weight: bolder; font-size: 18px;"><?php echo $row['city'] ?></p>
