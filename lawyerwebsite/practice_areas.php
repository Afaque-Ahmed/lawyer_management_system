        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="section-title1 text-center">
                    <h2>Practice Area</h2>
                    <p>practice area means a generally recognised or distinctive area of knowledge and expertise developed by an engineering practitioner by virtue of the path of education, training and experience followed.</p>
                </div>
            </div>
        </div>
