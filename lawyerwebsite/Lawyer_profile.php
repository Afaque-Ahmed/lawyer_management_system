...
<?php if (isset($_SESSION['role']) == "Lawyer") { ?>
  ...
  if (isset($_REQUEST['submit'])) {
    ...
    $pdo_statement->bindValue(':image', $image);
      ...
      <div class="col-md-12">
        ...
        if (isset($Message)) { ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Congrates!</strong> <?php echo $Message ?>
                ...
                <div class="tab-pane  fade profile-edit pt-3" id="profile-edit">
                  ...
                  if ($selectquery->rowCount() > 0) {
                    ...
                    if ($result['User_Id'] == $_SESSION['id']) {
                      ...
                      $_SESSION['Lawyerimage'] = $result['image'];
                  ...
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <?php } elseif ($row['image'] != "") { ?>
                        ...
                        <input class="form-control" name="image" value="<?php echo $row['image'] ?>" type="hidden">
                      <?php }
                      ?>
                    ...
                    <div class="row m-3">
                      ...
                      <?php } elseif ($row['cnic'] != "") { ?>
                        <label class="col-md-2">CNIC</label>
                        <div class="col-md-10">
                          <input readonly name="new_cnic" readonly type="text" class="form-control" style="width:100%" value="<?php echo $row['cnic'] ?>">
                        </div>
                      <?php } ?>
                    ...
                    <div class="row m-3">
                      ...
                      <?php } elseif ($row['mobile_number'] != "") { ?>
                        ...
                        <div class="col-md-10">
                          <input readonly name="phone_number" type="text" class="form-control" style="width:100%" value="<?php echo $row['mobile_number'] ?>">
                        </div>
                    ...
                    <div class="row m-3">
                      ...
                      <div class="col-md-10">
                        ...
                        <?php } elseif ($row['address'] != "") { ?>
                          ...
                          <input readonly name="address" value="<?php echo $row['address'] ?>" type="text" class="form-control" placeholder="Your Address">
                    ...
                    <div class="row m-3">
                      ...
                      <?php } elseif ($row['dob'] != "") { ?>
                        ...
                        <div class="col-md-10">
                          <input readonly name="new_date" type="text" class="form-control" style="width:100%" value="<?php echo $row['dob'] ?>">
                        </div>
                    ...
                    <div class="row m-3">
                      ...
                      <div class="col-md-10">
                        ...
                        <?php } elseif ($row['lawyer_case_done'] != "") { ?>
                          ...
                          <input readonly name="case_done" type="text" class="form-control" value="<?php echo $row['lawyer_case_done'] ?>">
                    ...
                    <div class="row m-3">
                      ...
                      <div class="col-md-10">
                        ...
                        <?php } elseif ($row['short_about'] != "") { ?>
                          ...
                          <input readonly type="text" name="short_about" value="<?php echo $row['short_about'] ?>" class="form-control">
                    ...
                    <div class="row m-3">
                      ...
                      <div class="col-md-10">
                        ...
                        <?php } elseif ($row['about_me'] != "") { ?>
                          ...
                          <input readonly type="text" name="about_you" value="<?php echo $row['about_me'] ?>" class="form-control">
                    ...
                    <div class="row m-3">
                      ...
                      <div class="col-md-10">
                        ...
                        <?php } elseif ($row['lawyer_personal_statement'] != "") { ?>
                          ...
                          <input readonly type="text" name="personal_statement" value="<?php echo $row['lawyer_personal_statement'] ?>" class="form-control">
                    ...
                    <div class="text-center">
                      <button type="submit" name="submit" class="btn" style="background-color: #D7B679;">Submit</button>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="POST">
                    ...
                    <script>
                      ...
                      function show() {
                        var b = document.getElementById('renewPassword')
                        if (b.type == 'password') {
                          b.type = 'text'
                        } else {
                          b.type = 'password'
